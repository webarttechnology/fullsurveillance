@section('title', 'Sub Category Edit | full Surveilance')
                ...
                <div class="col-lg-12">
                    <div class="profile-content-right profile-right-spacing py-5">
                        <ul class="nav nav-tabs px-3 px-xl-5 nav-style-border" id="myProfileTab" role="tablist">
                            <li><a href="{{ route('sub-category.index') }}">All SubCategory</a></li>
                        </ul>
                        <div class="tab-content px-3 px-xl-5" id="myTabContent">
                            <div class="tab-pane fade show active" id="settings" role="tabpanel"
                                aria-labelledby="settings-tab">
                                <div class="tab-pane-content mt-5">
                                    <form action="{{ route('sub-category.update', $subCategory->id) }}" method="post" class="save" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            @if ($subCategory->img)
                                              <div class="mb-3">
                                                  <img src="{{ url($subCategory->img) }}" width="100" alt="image">
                                              </div>
                                            @endif
                                           </div>
                                            <div class="col-md-12">
